        ...
        <div className="bg-amber-50 border-b-2 border-amber-200 px-4 py-2">
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
            ...
            <a
              ...
              className="flex-shrink-0 inline-flex items-center gap-1 bg-amber-500 hover:bg-amber-600 text-white font-semibold text-xs px-3 py-1.5 rounded-lg transition-colors"
            >
