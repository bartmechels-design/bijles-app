...
export default async function ChatPage({ params, searchParams }: ChatPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-amber-50 flex flex-col">
      ...
      {/* NotebookLM banner voor zaakvakken */}
      {subjectInfo.category === 'zaak' && (
        <div className="bg-amber-50 border-b-2 border-amber-200 px-4 py-2">
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
            <p className="text-amber-800 text-sm">
              📚 {t('tutor.zaakVakSessionHint')}
            </p>
            <div className="flex items-center gap-2 flex-shrink-0">
              <a
                ...
                className="inline-flex items-center gap-1 bg-amber-500 hover:bg-amber-600 text-white font-semibold text-xs px-3 py-1.5 rounded-lg transition-colors"
              >
                {t('tutor.notebooklmButton')}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 bg-white border border-amber-400 text-amber-700 hover:bg-amber-100 font-semibold text-xs px-3 py-1.5 rounded-lg transition-colors"
              >
                {t('tutor.notebooklmVideoButton')}
              </a>
            </div>
          </div>
        </div>
